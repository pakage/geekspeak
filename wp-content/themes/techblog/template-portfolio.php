...
<div id="main-container">
    ...
    <?php foreach($pageChunks[$pageNumber-1] as $post): ?>
        ...
        <div class="container-inner">
            ...
            <div class="portfolio">
                ...
                <div class="listing-main">
                    <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                        <h1 class="post-title"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php printf(__('Check out %s', 'responsive'), the_title_attribute('echo=0')); ?>"><?php the_title(); ?></a></h1>
    ...
    <div id="pagination-container">
        <div class="container-inner">
            <div id="pagination">
                ...
                <span class="nav-previous"><a href="<?php echo site_url(); ?>/portfolio/page/<?php echo $pageNumber +1; ?>"><span class="meta-nav">←</span> older work</a></span>
                <?php endif; ?>
                <?php if($pageNumber > 1): ?>
                <span class="nav-next"><a href="<?php echo site_url(); ?>/portfolio/page/<?php echo $pageNumber -1; ?>">newer work <span class="meta-nav">→</span></a></span> 
                <?php endif; ?>
                <div class="clear"></div>
            </div>
        </div>
