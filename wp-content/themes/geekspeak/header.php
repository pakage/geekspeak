...
<head>
    ...
    <!--[if lte IE 7]><link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url'); ?>/css/ie7.css" /><![endif]-->
    ...
    if($currentPage == get_site_url()."/"){ //if home page
        ...
        $ogTitle = "Geek Speak - ".$post->post_title;
...
<body <?php body_class(); ?>>
    ...
    <div id="site-container" class="<?php echo $siteClass; ?>">   
        ...
        <div id="ie7">
            <p>This site is not optimized for IE7 and below, for the best viewing experience please upgrade your browser to <a href="http://windows.microsoft.com/en-us/internet-explorer/downloads/ie-9/worldwide-languages" title="Internet Explorer 9">Internet Explorer 9</a> / <a href="http://www.mozilla.org/en-US/firefox/new/" title="Firefox">Firefox</a> / <a href="http://www.apple.com/nz/safari/" title="Safari">Safari</a> / <a href="https://www.google.com/intl/en/chrome/browser/" title="Chrome">Chrome</a></p>
        </div>
        ...
        <div id="full-nav">
            <ul>
                ...
                <?php endforeach; ?>
                <li class="divider"><span>&nbsp;</span></li>
                <li><a href="javascript:void(0);" title="Search & Share" class="search-share"><span>SEARCH</span><span class="up-down-arrows"></span></a></li>
                <li class="divider" id="search-divider"><span>&nbsp;</span></li>
            </ul>
            <div class="clear"></div>
        </div>
